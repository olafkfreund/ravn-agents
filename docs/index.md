...
your infrastructure. The *healing* loop executes on Linux/NixOS hosts; the
in-cluster Kubernetes executor has now landed and is pending k3d end-to-end
verification before release — see the
